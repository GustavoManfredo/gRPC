...
const (
	...
	Greeter_GetPerson_FullMethodName     = "/Greeter/GetPerson"
)
...
type GreeterClient interface {
	...
	GetPerson(ctx context.Context, in *Person, opts ...grpc.CallOption) (*PersonResponse, error)
}
...
func (c *greeterClient) GetPerson(ctx context.Context, in *Person, opts ...grpc.CallOption) (*PersonResponse, error) {
	out := new(PersonResponse)
	err := c.cc.Invoke(ctx, Greeter_GetPerson_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	GetPerson(context.Context, *Person) (*PersonResponse, error)
...
func (UnimplementedGreeterServer) GetPerson(context.Context, *Person) (*PersonResponse, error) {
...
func _Greeter_GetPerson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeter_GetPerson_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).GetPerson(ctx, req.(*Person))
	}
	return interceptor(ctx, in, info, handler)
}
